...
skill after it reads that file first. The Close (g6) writes squad/sales.md,
squad/sales-page.md and squad/pipeline.md. The deck lives in squad/mep/, one
folder per buyer (g7). The 90-Day Plan (g8) writes squad/90-day-plan.md.
